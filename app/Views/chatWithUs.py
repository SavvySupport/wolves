...
def chatWithUs():
    if request.method == 'POST':
        ...
        msg['Subject'] = 'You have a suggestion!'
        msg['From'] = 'weiyew@savvysme.com.au'
        msg['To'] = 'weiyew@savvysme.com.au'
        From = 'weiyew@savvysme.com.au'
        To = 'weiyew@savvysme.com.au'

        text = """Dear Awesome,\nSomeone cool has left a message for you using the textarea from the aboutus page!\nHere's the message:\n"{}"\nBest,\nTeam SavvyHire
        """.format(message)
        ...
        <html>
          <head></head>
          <body style="{}">
            <p><span style="{}">Dear awesome,<br><br></span>
               <span style="{}">
               Someone cool has left a message for you using the textarea from the aboutus page!<br><br>
        ...
        """.format(bodyStyle, greetStyle, contentStyle, messageStyle, message)
